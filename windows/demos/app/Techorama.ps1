...
# Build container
docker image build --tag $IMAGE "C:\Demos\dac\Jobs";
...
Start-Process "http://$(docker container inspect --format '{{ .NetworkSettings.Networks.nat.IPAddress }}' jobs-$USER):8080"
...
Start-Process "https://dtr.west.us.se.dckr.org/repositories/$env:USERNAME/jobs/tags"
...
Start-Processre "http://jobs.$USER.swarm.west.us.se.dckr.org"; # Open the application
